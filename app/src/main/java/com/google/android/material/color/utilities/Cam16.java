...
public final class Cam16 {
    ...
    static Cam16 fromIntInViewingConditions(int i, ViewingConditions viewingConditions) {
        ...
        double d = (0.41233895d * dLinearized) + (0.35762064d * dLinearized2) + (0.18051042d * dLinearized3);
        double d2 = (0.2126d * dLinearized) + (0.7152d * dLinearized2) + (0.0722d * dLinearized3);
        double d3 = (dLinearized * 0.01932141d) + (dLinearized2 * 0.11916382d) + (dLinearized3 * 0.95034478d);
