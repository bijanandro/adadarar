...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", "drawable", MetricCommonTags.METRIC_COMMON_TAG_PLATFORM_ANDROID);
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM301m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM301m = C$$ExternalSyntheticApiModelOutline0.m301m(getContext().getSystemService(C$$ExternalSyntheticApiModelOutline0.m303m()))) != null) {
                autofillManagerM301m.notifyValueChanged(this);
            }
