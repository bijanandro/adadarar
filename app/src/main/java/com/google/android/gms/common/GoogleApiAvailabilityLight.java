...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        ...
        Uri.Builder builderAppendQueryParameter = Uri.parse("market://details").buildUpon().appendQueryParameter(UnityNotificationManager.KEY_ID, "com.google.android.gms");
