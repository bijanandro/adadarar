...
public class Cache {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:38:0x0084 -> B:56:0x0087). Please report as a decompilation issue!!! */
    @WebViewExposed
    public static void setFileContent(String str, String str2, String str3, WebViewCallback webViewCallback) throws Throwable {
        ...
        try {
            ...
            if (str2 != null && str2.length() > 0) {
                ...
                } else if (!str2.equals(Key.STRING_CHARSET_NAME)) {
                    webViewCallback.error(CacheError.UNSUPPORTED_ENCODING, str, strFileIdToFilename, str2);
                    return;
                }
            }
