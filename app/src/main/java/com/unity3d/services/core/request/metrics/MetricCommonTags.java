...
public class MetricCommonTags {
    ...
    public Map<String, String> asMap() {
        ...
        if (this._countryISO != null) {
            map.put(METRIC_COMMON_TAG_SDK_VERSION, this._sdkVersion);
        }
        String str3 = this._systemVersion;
        if (str3 != null) {
            map.put(METRIC_COMMON_TAG_SYSTEM_VERSION, str3);
        }
        String str4 = this._privacyMode;
        if (str4 != null) {
            map.put(METRIC_COMMON_TAG_PRIVACY_MODE, str4);
        }
        String str5 = this._configSrc;
        if (str5 != null) {
            map.put(METRIC_COMMON_TAG_CONFIG_SOURCE, str5);
        }
        String str6 = this._mediationName;
        if (str6 != null) {
            map.put(METRIC_COMMON_TAG_MEDIATION_NAME, str6);
        }
        String str7 = this._mediationVersion;
        if (str7 != null) {
            map.put(METRIC_COMMON_TAG_MEDIATION_VERSION, str7);
        }
        String str8 = this._mediationAdapter;
        if (str8 != null) {
            map.put(METRIC_COMMON_TAG_MEDIATION_ADAPTER, str8);
        }
