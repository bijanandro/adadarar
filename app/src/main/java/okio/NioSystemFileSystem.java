...
public final class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public FileMetadata metadataOrNull(Path path) throws IOException {
        java.nio.file.Path pathM313m;
        Intrinsics.checkNotNullParameter(path, "path");
        java.nio.file.Path nioPath = path.toNioPath();
        try {
            BasicFileAttributes attributes = Files.readAttributes(nioPath, (Class<BasicFileAttributes>) Headers$$ExternalSyntheticApiModelOutline0.m(), LinkOption.NOFOLLOW_LINKS);
            if (attributes.isSymbolicLink()) {
                pathM313m = Files.readSymbolicLink(nioPath);
            } else {
                pathM313m = C$$ExternalSyntheticApiModelOutline0.m313m((Object) null);
            }
            boolean zIsRegularFile = attributes.isRegularFile();
            boolean zIsDirectory = attributes.isDirectory();
            Path path2 = pathM313m != null ? Path.Companion.get$default(Path.INSTANCE, pathM313m, false, 1, (Object) null) : null;
