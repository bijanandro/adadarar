...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2031deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2033deprecated_tlsVersions() {
        return tlsVersions();
    }
