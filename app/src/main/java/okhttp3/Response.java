...
public final class Response implements Closeable {
    ...
    public final CacheControl m2156deprecated_cacheControl() {
        return cacheControl();
    }
