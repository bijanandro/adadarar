...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m2114deprecated_get(String mediaType) {
        ...
        public final MediaType m2115deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
