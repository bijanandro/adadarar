...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM449constructorimpl = Result.m449constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM449constructorimpl = Result.m449constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m455isFailureimpl(objM449constructorimpl) ? null : objM449constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1968installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1968installSignalHandler$lambda1(Signal signal) {
