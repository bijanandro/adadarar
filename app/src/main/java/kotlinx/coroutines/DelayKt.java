...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1992scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1929delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1930toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1930toDelayMillisLRDsOJo(long j) {
        if (Duration.m1770compareToLRDsOJo(j, Duration.INSTANCE.m1873getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1789getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
