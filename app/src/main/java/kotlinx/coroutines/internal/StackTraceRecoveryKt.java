...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM449constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM449constructorimpl = Result.m449constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM449constructorimpl = Result.m449constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m452exceptionOrNullimpl(objM449constructorimpl) == null) {
            obj2 = objM449constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM449constructorimpl2 = Result.m449constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM449constructorimpl2 = Result.m449constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m452exceptionOrNullimpl(objM449constructorimpl2) == null) {
            obj = objM449constructorimpl2;
        }
