...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1977catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m1969catch(sharedFlow, function3);
    }
