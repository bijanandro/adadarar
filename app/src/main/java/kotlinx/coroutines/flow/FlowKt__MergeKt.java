...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C01921<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01921(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C01921> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Override // kotlin.jvm.functions.Function3
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C01921 c01921 = new C01921(this.$transform, continuation);
            c01921.L$0 = flowCollector;
            c01921.L$1 = t;
            return c01921.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C01921(function2, null));
    }
