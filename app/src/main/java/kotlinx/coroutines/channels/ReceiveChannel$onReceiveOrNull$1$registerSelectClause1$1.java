...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1966invokeWpGqRn0(((ChannelResult) obj).getHolder(), (Continuation) obj2);
    }

    /* JADX INFO: renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m1966invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1950boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            Throwable thM1954exceptionOrNullimpl = ChannelResult.m1954exceptionOrNullimpl(holder);
            if (thM1954exceptionOrNullimpl != null) {
                throw thM1954exceptionOrNullimpl;
            }
            Function2<E, Continuation<? super R>, Object> function2 = this.$block;
            Object objM1955getOrNullimpl = ChannelResult.m1955getOrNullimpl(holder);
            this.label = 1;
            obj = function2.invoke(objM1955getOrNullimpl, this);
