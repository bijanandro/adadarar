...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1944tryReceivePtdJZtk = receiveChannel.mo1944tryReceivePtdJZtk();
            if (ChannelResult.m1960isSuccessimpl(objMo1944tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1956getOrThrowimpl(objMo1944tryReceivePtdJZtk);
            }
            Throwable thM1954exceptionOrNullimpl = ChannelResult.m1954exceptionOrNullimpl(objMo1944tryReceivePtdJZtk);
            if (thM1954exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1954exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1943receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1955getOrNullimpl(r4)
                return r4
            */
