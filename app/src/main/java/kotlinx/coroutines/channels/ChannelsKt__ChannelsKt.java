...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM449constructorimpl = Result.m449constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM449constructorimpl = Result.m449constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1950boximpl(Result.m456isSuccessimpl(objM449constructorimpl) ? ChannelResult.INSTANCE.m1965successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1963closedJP2dKIU(Result.m452exceptionOrNullimpl(objM449constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1945trySendJP2dKIU = sendChannel.mo1945trySendJP2dKIU(e);
        if (objMo1945trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1960isSuccessimpl(sendChannel.mo1945trySendJP2dKIU(e))) {
            return;
        }
