...
public final class TimeoutKt {
    ...
    public static final <T> Object m1938withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1930toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m1939withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1930toDelayMillisLRDsOJo(j), function2, continuation);
    }
