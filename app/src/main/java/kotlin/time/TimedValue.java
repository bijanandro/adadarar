...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1923copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1925copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1925copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1776equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1799hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1820toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1926getDurationUwyO8pc() {
        return this.duration;
    }
