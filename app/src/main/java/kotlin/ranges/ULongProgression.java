...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1663getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM621constructorimpl = ((int) ULong.m621constructorimpl(j ^ ULong.m621constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM621constructorimpl2 = (iM621constructorimpl + ((int) ULong.m621constructorimpl(j2 ^ ULong.m621constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM621constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m666toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m666toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1689fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
