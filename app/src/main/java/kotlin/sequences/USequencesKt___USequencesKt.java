...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM543constructorimpl = 0;
        while (it.hasNext()) {
            iM543constructorimpl = UInt.m543constructorimpl(iM543constructorimpl + it.next().getData());
        }
        return iM543constructorimpl;
    }

    public static final long sumOfULong(Sequence<ULong> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Iterator<ULong> it = sequence.iterator();
        long jM621constructorimpl = 0;
        while (it.hasNext()) {
            jM621constructorimpl = ULong.m621constructorimpl(jM621constructorimpl + it.next().getData());
        }
        return jM621constructorimpl;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM543constructorimpl = 0;
        while (it.hasNext()) {
            iM543constructorimpl = UInt.m543constructorimpl(iM543constructorimpl + UInt.m543constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return iM543constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM543constructorimpl = 0;
        while (it.hasNext()) {
            iM543constructorimpl = UInt.m543constructorimpl(iM543constructorimpl + UInt.m543constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM543constructorimpl;
    }
}
