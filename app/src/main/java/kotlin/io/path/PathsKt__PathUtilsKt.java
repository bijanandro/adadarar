...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path relativeToOrNull(Path path, Path base) {
        ...
        try {
            ...
            return C$$ExternalSyntheticApiModelOutline0.m313m((Object) null);
        }
    }
    ...
    static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z, int i, Object obj) throws IOException {
        ...
        if (z) {
            copyOptionArr = new CopyOption[]{Headers$$ExternalSyntheticApiModelOutline0.m((Object) StandardCopyOption.REPLACE_EXISTING)};
        } else {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream it = Headers$$ExternalSyntheticApiModelOutline0.m2055m((Object) directoryStreamNewDirectoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, Headers$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, Headers$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) Headers$$ExternalSyntheticApiModelOutline0.m2063m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        PathsKt.fileAttributeViewNotAvailable(path, Headers$$ExternalSyntheticApiModelOutline0.m$1());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) Headers$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(this, A::class.java, *options)");
        return (A) Headers$$ExternalSyntheticApiModelOutline0.m2062m((Object) attributes);
    }
