...
class PathsKt__PathReadWriteKt {
    ...
    private static final void appendBytes(Path path, byte[] array) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(array, "array");
        Files.write(path, array, Headers$$ExternalSyntheticApiModelOutline0.m2057m((Object) StandardOpenOption.APPEND));
    }
    ...
    public static final void appendText(Path path, CharSequence text, Charset charset) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(charset, "charset");
        OutputStream outputStreamNewOutputStream = Files.newOutputStream(path, Headers$$ExternalSyntheticApiModelOutline0.m2057m((Object) StandardOpenOption.APPEND));
    ...
    static /* synthetic */ Path appendLines$default(Path path, Iterable lines, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(lines, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path pathWrite = Files.write(path, lines, charset, Headers$$ExternalSyntheticApiModelOutline0.m2057m((Object) StandardOpenOption.APPEND));
    ...
    static /* synthetic */ Path appendLines$default(Path path, Sequence lines, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(lines, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path pathWrite = Files.write(path, SequencesKt.asIterable(lines), charset, Headers$$ExternalSyntheticApiModelOutline0.m2057m((Object) StandardOpenOption.APPEND));
