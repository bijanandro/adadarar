...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult postVisitDirectory(Object obj, IOException iOException) {
        return postVisitDirectory(C$$ExternalSyntheticApiModelOutline0.m313m(obj), iOException);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult preVisitDirectory(Object obj, BasicFileAttributes basicFileAttributes) {
        return preVisitDirectory(C$$ExternalSyntheticApiModelOutline0.m313m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFile(Object obj, BasicFileAttributes basicFileAttributes) {
        return visitFile(C$$ExternalSyntheticApiModelOutline0.m313m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(C$$ExternalSyntheticApiModelOutline0.m313m(obj), iOException);
    }
    ...
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
        FileVisitResult fileVisitResultM310m;
        Intrinsics.checkNotNullParameter(dir, "dir");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Function2<Path, BasicFileAttributes, FileVisitResult> function2 = this.onPreVisitDirectory;
        if (function2 != null && (fileVisitResultM310m = C$$ExternalSyntheticApiModelOutline0.m310m((Object) function2.invoke(dir, attrs))) != null) {
            return fileVisitResultM310m;
        }
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM310m = C$$ExternalSyntheticApiModelOutline0.m310m((Object) function2.invoke(file, attrs))) != null) {
            return fileVisitResultM310m;
        }
    ...
    public FileVisitResult visitFileFailed(Path file, IOException exc) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM310m = C$$ExternalSyntheticApiModelOutline0.m310m((Object) function2.invoke(file, exc))) != null) {
            return fileVisitResultM310m;
        }
    ...
    public FileVisitResult postVisitDirectory(Path dir, IOException exc) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM310m = C$$ExternalSyntheticApiModelOutline0.m310m((Object) function2.invoke(dir, exc))) != null) {
            return fileVisitResultM310m;
        }
