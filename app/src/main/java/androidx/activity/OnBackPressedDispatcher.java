...
public final class OnBackPressedDispatcher {
        ...
        if (BuildCompat.isAtLeastT()) {
            this.mEnabledConsumer = new Consumer() { // from class: androidx.activity.OnBackPressedDispatcher$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m34lambda$new$0$androidxactivityOnBackPressedDispatcher((Boolean) obj);
                }
            };
    ...
    /* synthetic */ void m34lambda$new$0$androidxactivityOnBackPressedDispatcher(Boolean bool) {
        if (BuildCompat.isAtLeastT()) {
            updateBackInvokedCallbackState();
        }
    }
