...
public class ExifInterface {
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r9.mAssetInputStream     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            if (r1 == 0) goto L2e
        ...
        L29:
            ...
            goto La0
        L2e:
            java.lang.String r1 = r9.mFilename     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            if (r1 == 0) goto L3a
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            java.lang.String r3 = r9.mFilename     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            r1.<init>(r3)     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            goto L1a
        L3a:
            java.io.FileDescriptor r1 = r9.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            if (r1 == 0) goto L5a
            java.io.FileDescriptor r1 = android.system.Os.dup(r1)     // Catch: java.lang.Throwable -> L99 java.lang.Exception -> L9c
            int r3 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L52 java.lang.Exception -> L55
            r4 = 0
            android.system.Os.lseek(r1, r4, r3)     // Catch: java.lang.Throwable -> L52 java.lang.Exception -> L55
        ...
        L5c:
            if (r1 == 0) goto L93
            int r4 = r9.mThumbnailOffset     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            long r4 = (long) r4     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            long r4 = r1.skip(r4)     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            int r6 = r9.mThumbnailOffset     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            long r6 = (long) r6
            int r4 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            java.lang.String r5 = "Corrupted image"
            if (r4 != 0) goto L8b
            int r4 = r9.mThumbnailLength     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            byte[] r4 = new byte[r4]     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            int r6 = r1.read(r4)     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            int r7 = r9.mThumbnailLength     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            if (r6 != r7) goto L85
            r9.mThumbnailBytes = r4     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            closeQuietly(r1)
            if (r3 == 0) goto L84
        ...
        L84:
            return r4
        L85:
            java.io.IOException r4 = new java.io.IOException     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            r4.<init>(r5)     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            throw r4     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
        L8b:
            java.io.IOException r4 = new java.io.IOException     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            r4.<init>(r5)     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
            throw r4     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
        L91:
            ...
            goto La0
        L93:
            java.io.FileNotFoundException r4 = new java.io.FileNotFoundException     // Catch: java.lang.Exception -> L91 java.lang.Throwable -> Lae
        ...
        La0:
            ...
            android.util.Log.d(r0, r5, r4)     // Catch: java.lang.Throwable -> Lae
            closeQuietly(r1)
            if (r3 == 0) goto Lad
            closeFileDescriptor(r3)
        Lad:
    ...
    */
                ...
                try {
                    ...
                    if (this.mExifOffset != 0) {
                        ...
                        if (Arrays.equals(bArr, bArr2)) {
                            int i = byteOrderedDataInputStream.readInt();
                            boolean z = true;
                            byte[] bArr3 = new byte[i % 2 == 1 ? i + 1 : i];
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r29, int r30) throws java.io.IOException {
        /*
