...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo183clone = transition.mo183clone();
        transitionMo183clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo183clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo183clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo183clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo183clone = transition.mo183clone();
        sceneChangeSetup(viewGroup, transitionMo183clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo183clone);
    }
