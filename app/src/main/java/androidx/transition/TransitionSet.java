...
public class TransitionSet extends Transition {
    ...
    public Transition mo183clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo183clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo183clone());
        }
