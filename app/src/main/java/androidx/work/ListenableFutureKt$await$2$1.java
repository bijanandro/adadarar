...
public final class ListenableFutureKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            continuation.resumeWith(Result.m449constructorimpl(this.$this_await.get()));
        } catch (Throwable th) {
            ...
            continuation2.resumeWith(Result.m449constructorimpl(ResultKt.createFailure(cause)));
        }
    }
}
