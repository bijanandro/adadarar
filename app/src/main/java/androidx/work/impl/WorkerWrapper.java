...
public class WorkerWrapper implements Runnable {
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m189lambda$runWorker$0$androidxworkimplWorkerWrapper(future);
                }
    ...
    /* synthetic */ void m189lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
