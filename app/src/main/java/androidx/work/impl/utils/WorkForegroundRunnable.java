...
public class WorkForegroundRunnable implements Runnable {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m193lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(settableFutureCreate);
            }
        });
    ...
    /* synthetic */ void m193lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture settableFuture) {
