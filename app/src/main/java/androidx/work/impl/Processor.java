...
public class Processor implements ExecutionListener, ForegroundProcessor {
    ...
    public boolean startWork(StartStopToken startStopToken, WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return this.f$0.m186lambda$startWork$0$androidxworkimplProcessor(arrayList, workSpecId);
            }
        });
        if (workSpec == null) {
    ...
    /* synthetic */ WorkSpec m186lambda$startWork$0$androidxworkimplProcessor(ArrayList arrayList, String str) throws Exception {
    ...
    public void m185lambda$runOnExecuted$1$androidxworkimplProcessor(final WorkGenerationalId id, boolean needsReschedule) {
        synchronized (this.mLock) {
            ...
            while (it.hasNext()) {
                it.next().m185lambda$runOnExecuted$1$androidxworkimplProcessor(id, needsReschedule);
            }
        }
    }
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m185lambda$runOnExecuted$1$androidxworkimplProcessor(id, needsReschedule);
            }
        });
    }
    ...
    private static class FutureListener implements Runnable {
        ...
        public void run() {
            ...
            this.mExecutionListener.m185lambda$runOnExecuted$1$androidxworkimplProcessor(this.mWorkGenerationalId, zBooleanValue);
        }
    }
}
