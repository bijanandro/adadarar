...
public final class RawWorkInfoDao_Impl implements RawWorkInfoDao {
    ...
    public List<WorkSpec.WorkInfoPojo> getWorkInfoPojos(final SupportSQLiteQuery query) {
        ...
        try {
            int columnIndex = CursorUtil.getColumnIndex(cursorQuery, UnityNotificationManager.KEY_ID);
            int columnIndex2 = CursorUtil.getColumnIndex(cursorQuery, AdOperationMetric.INIT_STATE);
