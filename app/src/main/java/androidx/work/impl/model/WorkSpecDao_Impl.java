...
public final class WorkSpecDao_Impl implements WorkSpecDao {
    ...
    public WorkSpec getWorkSpec(final String id) throws Throwable {
        ...
        try {
            columnIndexOrThrow = CursorUtil.getColumnIndexOrThrow(cursorQuery, UnityNotificationManager.KEY_ID);
            columnIndexOrThrow2 = CursorUtil.getColumnIndexOrThrow(cursorQuery, AdOperationMetric.INIT_STATE);
    ...
    public List<WorkSpec> getScheduledWork() throws Throwable {
        ...
        Cursor cursorQuery = DBUtil.query(this.__db, roomSQLiteQueryAcquire, false, null);
        try {
            int columnIndexOrThrow = CursorUtil.getColumnIndexOrThrow(cursorQuery, UnityNotificationManager.KEY_ID);
            int columnIndexOrThrow2 = CursorUtil.getColumnIndexOrThrow(cursorQuery, AdOperationMetric.INIT_STATE);
