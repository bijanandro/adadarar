...
public class CommandHandler implements ExecutionListener {
    ...
    public void m185lambda$runOnExecuted$1$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        for (StartStopToken startStopToken : listRemove) {
            ...
            dispatcher.m185lambda$runOnExecuted$1$androidxworkimplProcessor(startStopToken.getId(), false);
        }
    }
    ...
    private void handleExecutionCompleted(Intent intent, int startId) {
        ...
        m185lambda$runOnExecuted$1$androidxworkimplProcessor(workGenerationalId, z);
    }
