...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        public final Constraints build() {
            ...
            return new Constraints(this.requiredNetworkType, this.requiresCharging, this.requiresDeviceIdle, this.requiresBatteryNotLow, this.requiresStorageNotLow, j, j2, setEmptySet);
        }
    }
    ...
    public static final class ContentUriTrigger {
        ...
        public int hashCode() {
            return (this.uri.hashCode() * 31) + Predicate$$ExternalSyntheticBackport0.m(this.isTriggeredForDescendants);
        }
    }
}
