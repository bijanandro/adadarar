...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        BitmapKt$$ExternalSyntheticApiModelOutline0.m70m$1();
        ShortcutInfo.Builder intents = BitmapKt$$ExternalSyntheticApiModelOutline0.m48m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, BitmapKt$$ExternalSyntheticApiModelOutline0.m49m((Object) it.next())).build());
        }
        return arrayList;
    }
