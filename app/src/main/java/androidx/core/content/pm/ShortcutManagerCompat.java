...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).getShortcuts(i));
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM50m = BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(shortcutManagerM50m.getManifestShortcuts());
            }
            if ((i & 2) != 0) {
                arrayList.addAll(shortcutManagerM50m.getDynamicShortcuts());
            }
            if ((i & 4) != 0) {
                arrayList.addAll(shortcutManagerM50m.getPinnedShortcuts());
            }
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).isRateLimitingActive();
        }
    ...
    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List dynamicShortcuts = BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, BitmapKt$$ExternalSyntheticApiModelOutline0.m49m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM50m = BitmapKt$$ExternalSyntheticApiModelOutline0.m50m(context.getSystemService(BitmapKt$$ExternalSyntheticApiModelOutline0.m$2()));
            if (shortcutManagerM50m.isRateLimitingActive()) {
                return false;
            }
            List dynamicShortcuts = shortcutManagerM50m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerM50m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerM50m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
