...
public final class InputConnectionCompat {
    ...
    public static boolean commitContent(InputConnection inputConnection, EditorInfo editorInfo, InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return Api25Impl.commitContent(inputConnection, a$$ExternalSyntheticApiModelOutline0.m203m(inputContentInfoCompat.unwrap()), i, bundle);
        }
    ...
    static /* synthetic */ boolean lambda$createOnCommitContentListenerUsingPerformReceiveContent$0(View view, InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 25 && (i & 1) != 0) {
            try {
                ...
                InputContentInfo inputContentInfoM203m = a$$ExternalSyntheticApiModelOutline0.m203m(inputContentInfoCompat.unwrap());
                bundle = bundle == null ? new Bundle() : new Bundle(bundle);
                bundle.putParcelable(EXTRA_INPUT_CONTENT_INFO, inputContentInfoM203m);
            } catch (Exception e) {
