...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m112m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m112m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m120m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m111m(contentInfoCompat.toContentInfo());
        }
