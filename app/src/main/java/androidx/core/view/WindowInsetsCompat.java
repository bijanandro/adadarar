...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m138m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM138m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM138m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m139m(windowInsets);
            } else {
                builderM138m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m138m();
            }
            this.mPlatBuilder = builderM138m;
        }
