    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (str.equals(BitmapKt$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    messagingStyleM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
                } else {
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2();
                    messagingStyleM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mUser.getName());
                }
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m$3();
                    messageM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
                    ComponentDialog$$ExternalSyntheticApiModelOutline0.m$3();
                    messageM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.getName() : null);
                }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m(it.next())));
                }
            }
        } else {
